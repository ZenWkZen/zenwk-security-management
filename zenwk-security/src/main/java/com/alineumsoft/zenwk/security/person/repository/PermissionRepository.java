...
public interface PermissionRepository extends JpaRepository<Permission, Long> {
	 ...
	 */
	public static final String JPQL_PERMISSIONS_FILTER_ROLE_ID = "SELECT p " + "FROM RolePermission rp "
			+ " JOIN rp.role r " + " JOIN rp.permission p " + "WHERE r.id =:roleId ";

	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Valida si un rol ya existe por su
	 * nombre
	 * </p>
	 * 
