...
import com.alineumsoft.zenwk.security.user.service.PersonService;
...
public class PersonController extends ApiRestHelper {
	...
	public ResponseEntity<Void> createPerson(@RequestBody PersonDTO inDTO, HttpServletRequest request,
		...
		URI location = uriCB.path(GeneralUserConstants.HEADER_PERSON_LOCATION).buildAndExpand(idPerson).toUri();
