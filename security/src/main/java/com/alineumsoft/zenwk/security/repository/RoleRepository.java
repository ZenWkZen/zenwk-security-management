...
public interface RoleRepository extends JpaRepository<Role, Long>, PagingAndSortingRepository<Role, Long> {
	 ...
	 */
	public static final String JPQL_ROLES_FILTER_PERMISSION_ID = "SELECT r " + "FROM RolePermission rp "
			+ " JOIN rp.role r " + " JOIN rp.permission p " + "WHERE p.id =:permissionId ";
	...
	/**
	 * <p>
	 * <b> CU001_Seguridad_Asignación_Roles </b> Consulta los roles con los id´s
	 * indicados
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Valida si ya existe un rol para ese
	 * nombre
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Filtra el resultado por el rol
	 * indicado.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
