...
public class RoleAssignmentService extends ApiRestSecurityHelper {
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Se genera una lista con el rol
	 * temporal new_user
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	 ...
	 * 
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Eliminacion de registros por id de
	 * usuario
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Asignamiento de un permiso a un
	 * rol. Si ya se encuentra asignado se genera error funcional.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	 * @param roleId
	...
	public void assignPermissionsToRole(Long roleId, Long permissionId, HttpServletRequest request,
		...
		try {
			...
			RolePermission assignmentPermission = getAssignmentPermissionToRol(role, permission).orElse(null);
			if (assignmentPermission == null) {
				assignmentPermission = new RolePermission(null, role, permission, LocalDateTime.now(), username);
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Remueve un permiso asignado a un
	 * rol si este existen en el sistema.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	 * @param roleId
	...
	public void removePermissionFromRole(Long roleId, Long permissionId, HttpServletRequest request,
		...
		try {
			...
			if (assignmentPermission != null) {
				...
				throw new EntityExistsException(SecurityExceptionEnum.FUNC_ROLE_ASSIGNMENT_PERMISSION_NOT_EXISTS
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Lista todos los permisos asociados
	 * a un rol.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	 ...
	 * @return
	 */
	public PageRolePermissionsDTO listPermissionsForRole(Pageable pageable, Long roleId, HttpServletRequest request,
			UserDetails userDetails) {
		String username = userDetails.getUsername();
		LogSecurity logSec = initializeLog(request, username, notBody, notBody,
		...
		try {
			...
			Page<Permission> pagePermission = permissionService.getPermissionsForRole(pageable, roleId, pageNumber);
			...
			return new PageRolePermissionsDTO(roleId, role.getName(), pagePermissionDTO.getPermissions(), paginator);
		} catch (RuntimeException e) {
			setLogSecurityError(e, logSec);
			throw new FunctionalException(e.getMessage(), e.getCause(), logSecRepo, logSec);
	 ...
	 * 
	 * <p>
	 * <b> CU001_Seguridad_Asignación_Roles </b> Obtiene todos los roles que tiene
	 * asignado un permiso.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	...
	public PagePermissionRolesDTO listRolesForPermission(Pageable pageable, Long permissionId,
		...
		try {
			...
			// Se obtiene la paginación
			PaginatorDTO paginator = new PaginatorDTO(pageRoleDTO.getTotalElements(), pageRoleDTO.getTotalPages(),
					pageRoleDTO.getCurrentPage());
			// Se persiste log
			saveSuccessLog(HttpStatus.OK.value(), logSec, logSecRepo);
			// Retorno con los datos paginados
			return new PagePermissionRolesDTO(permissionId, permisssion.getName(),
					permisssion.getMethod().concat(" ").concat(permisssion.getResource()), pageRoleDTO.getRoles(),
					paginator);
		} catch (RuntimeException e) {
			setLogSecurityError(e, logSec);
			throw new FunctionalException(e.getMessage(), e.getCause(), logSecRepo, logSec);
	...
	/**
	 * <p>
	 * <b> CU002_Seguridad_Asignación_Roles </b> Actualiza un role y un permiso si
	 * se encuentran asociados en el sistema.
	 * </p>
	 * 
	 * @author <a href="alineumsoft@gmail.com">C. Alegria</a>
	 * @param role
