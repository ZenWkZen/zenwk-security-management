...
/**
 * <p>
 * Clase encargada de manejar los errores de acceso denegado en la aplicación.
 * Implementa la interfaz {@link AccessDeniedHandler} para personalizar la
 * respuesta cuando un usuario no tiene los permisos necesarios para acceder a
 * un recurso.
 * </p>
 * <p>
 * Al interceptar una excepción de acceso denegado, esta clase envía una
 * respuesta personalizada con un código HTTP 403 (Forbidden) y un mensaje en
 * formato JSON indicando que el acceso al recurso está prohibido.
 * </p>
 * 
