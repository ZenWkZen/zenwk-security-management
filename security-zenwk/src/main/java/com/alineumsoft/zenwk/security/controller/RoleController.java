...
public class RoleController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Void> createRole(@Valid @RequestBody RoleDTO dto, HttpServletRequest request,
		...
		URI location = uriCB.path(HttpMethodResourceEnum.ROLE_GET.getResource()).buildAndExpand(idRole).toUri();
	...
	/**
	 * <p>
	 * <b> CU001_Seguridad_Creación_Usuario </b>Obtiene todos los roles registrados
	 * en el sistema.
	 * </p>
	 *
	 * @param pageable
	...
	public ResponseEntity<Void> assignPermissionsToRole(@PathVariable Long roleId, @PathVariable Long permissionId,
			HttpServletRequest request, @AuthenticationPrincipal UserDetails userDetails) {
	...
	public ResponseEntity<PageRolePermissionsDTO> listPermissionsForRole(Pageable pageable, @PathVariable Long roleId,
			HttpServletRequest request, @AuthenticationPrincipal UserDetails userDetails) {
		PageRolePermissionsDTO pageRolePermissions = roleAssignmentService.listPermissionsForRole(pageable, roleId,
				request, userDetails);
	...
	/**
	 * <p>
	 * <b>CU002_Seguridad_Asignación_Roles</b> - Obtiene todos los roles que tiene
	 * asignado un permiso.
	 * </p>
	 * 
	 * @param pageable
	...
	public ResponseEntity<PagePermissionRolesDTO> listRolesForPermission(Pageable pageable,
			...
			@AuthenticationPrincipal UserDetails userDetails) {
		PagePermissionRolesDTO pagePermissionRolesDTO = roleAssignmentService.listRolesForPermission(pageable,
				permissionId, request, userDetails);
