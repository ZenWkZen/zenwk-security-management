...
public class PermissionDTO implements Serializable {
	 ...
	 * Nombre del rol
	 */
	@Pattern(regexp = RegexConstants.NAME_ROLE_PERMISSION, message = DtoValidationKeys.PERMISSION_NAME_INVALID)
	 ...
	 * Metodo http
	 */
	@Pattern(regexp = RegexConstants.NAME_ROLE_PERMISSION, message = DtoValidationKeys.PERMISSION_METHOD_INVALID)
	 ...
	 * Recurso
	 */
	@Pattern(regexp = RegexConstants.RESOURCE_PERMISSION, message = DtoValidationKeys.PERMISSION_RESOURCE_INVALID)
	 ...
	 * Operacion
	 */
	@Pattern(regexp = RegexConstants.OPERATION_PERMISSION, message = DtoValidationKeys.PERMISSION_OPERATION_INVALID)
